...
<div class='block_panopto'>
    <div class='courseProvisionResult'>
        <div class='attribute'><? echo get_string('course_name', 'block_panopto') ?></div>
        <div class='value'><?php echo $provisioningdata->ShortName . ": " . $provisioningdata->LongName ?></div>

        <div class='attribute'><? echo get_string('publishers', 'block_panopto') ?></div>
        <div class='value'>
            <?php
                ...
                ?><div class='errorMessage'><? echo get_string('no_publishers', 'block_panopto') ?></div><?php
                }
                ?>
        </div>

        <div class='attribute'><? echo get_string('creators', 'block_panopto') ?></div>
        <div class='value'>
            <?php
            if (!empty($provisioningdata->Instructors)) {
                ...
                ?><div class='errorMessage'><? echo get_string('no_creators', 'block_panopto') ?></div><?php
            }
            ?>
        </div>
        <div class='attribute'><? echo get_string('students', 'block_panopto') ?></div>
        <div class='value'>
            <?php
            if (!empty($provisioningdata->Students)) {
                ...
                ?><div class='errorMessage'><? echo get_string('no_students', 'block_panopto') ?></div><?php
            }
            ?>
        </div>
        <div class='attribute'><? echo get_string('result', 'block_panopto') ?></div>
        <div class='value'>
            <?php
            if (!empty($provisioneddata)) {
                ?>
                <div class='successMessage'><? echo get_string('provision_successful', 'block_panopto') ?> {<?php echo $provisioneddata->PublicID ?>}</div>
                <?php
            } else {
                ?>
                <div class='errorMessage'><? echo get_string('provision_error', 'block_panopto') ?></div>
                <?php
            }
            ?>
        </div>
