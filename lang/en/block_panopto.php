...
$string['block_edit_header_help'] = 'TODO: Finalize - Choose the course on your panopto server to display on this block, or make a new course on panopto to map to this course.';
...
$string['creator_help'] = 'TODO: Finalize - A creator can create new content on panopto (need more input here).';
...
$string['publisher_help'] = 'TODO: Finalize - (need input here on role capabilities).';
$string['publishers'] = 'Publishers';
$string['result'] = 'Result';
$string['role_map_header'] = 'Change Panopto Role Mappings';
$string['role_map_header_help'] = "TODO: Finalize - Choose which Panopto roles a user's Moodle role will map to. <br> Unmapped roles will be given the 'Viewer' role in Panopto. <br><br>";
