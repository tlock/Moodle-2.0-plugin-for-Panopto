...
$string['block_panopto_async_tasks'] = 'Asynchronous cleanup sync';
$string['block_panopto_async_tasks_desc'] = 'Enable this option to allow the unenrolment and delete user cleanup tasks to happen asynchronously (may have a short delay before running)';
...
$string['no_users_synced_desc'] = 'With new API all users enrolled in this course will be synced with Panopto when they attempt to access a Panopto block through Moodle.';
$string['or'] = 'OR';
