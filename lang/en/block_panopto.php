...
$string['block_panopto_publisher_system_role_mapping'] = 'System roles that can provision';
$string['block_panopto_publisher_system_role_mapping_desc'] = 'Select which system roles can provision Panopto courses.';
$string['block_panopto_publisher_mapping'] = 'Publisher role mapping';
$string['block_panopto_publisher_mapping_desc'] = 'Select which system roles are set to publishers in new panopto courses.';
$string['block_panopto_creator_mapping'] = 'Creator role mapping';
$string['block_panopto_creator_mapping_desc'] = 'Select which system roles are set to creators in new panopto courses.';
