...
$string['folder_not_found_error'] = 'The folder currenty provisioned to the target Moodle couse on the Panopto server could not be found, was it deleted? Provisioning will continue by linking to the default Moodle folder or creating one if it does not already exist.';
...
$string['or'] = 'OR';
$string['panopto_server_error'] = 'Panopto server returned with server error, will try again on next sign in.';
